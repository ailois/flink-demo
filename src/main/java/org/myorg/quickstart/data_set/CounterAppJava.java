...
public class CounterAppJava {
    ...
    public static void main(String[] args) throws Exception {
        ...
        info.writeAsText("F:\\code\\flink-demo\\sink", FileSystem.WriteMode.OVERWRITE).setParallelism(2);

        JobExecutionResult jobExecutionResult = env.execute("counter app java");
